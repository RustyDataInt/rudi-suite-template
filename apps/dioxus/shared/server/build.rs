//! RuDI shared server `build.rs` converts a developer's app configuration files 
//! into all required server code, including imports, structures, and enums.
...
/// Main server build function. All actions are inherited from the 
/// rudi-apps-framework.
fn main() {
